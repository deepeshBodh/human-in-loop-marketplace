...
- Provide explicit command suggestions: e.g., "Run /humaninloop-specs:specify with refinement", "Run /humaninloop:plan to adjust architecture", "Manually edit tasks.md to add coverage for 'performance-metrics'"
