...
Patterns for applying user answers to specifications and managing gap resolution.
...
4. **List all assumptions prominently** in handoff notes
...
### Update Requirements -> Checklist Coverage

```markdown
| FR ID | CHK IDs | Coverage Status | Notes |
|-------|---------|-----------------|-------|
| FR-003 | CHK015 | Covered | Gap resolved via C1.1 |
```

### Update Checklist -> Requirements Mapping

```markdown
| CHK ID | FR IDs | Gap Type | Resolution |
|--------|--------|----------|------------|
| CHK015 | FR-003 | Clarity | C1.1 -> FR-003a, FR-003b |
```
